...
Two species exhibited strong negative relationships between tree diameter (cm) and leaf SLA: _Liquidambar styraciflua_ (SLA = `r msc_list$m`D + `r msc_list$b`, `r msc_list$p_pretty`) and _Nyssa sylvatica_ (SLA = `r msc_nysy$m`D + `r msc_nysy$b`, `r msc_nysy$p_pretty`). Two others were marginally significant: _Acer rubrum_ (SLA = `r msc_acru$m`D + `r msc_acru$b`, `r msc_acru$p_pretty`) and _Liriodendron tulipifera_ (SLA = `r msc_litu$m`D + `r msc_litu$b`, `r msc_litu$p_pretty`). Tree diameter was unrelated to SLA for the other three species (Figure X).
