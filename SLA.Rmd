...
distribution in TRY; the two exceptions were _Liriodendron tulipifera_(D = `r tryt$LITU$D`, 
...
print(litter_plot)
save_plot("figures/fig5-litter.png", plot = litter_plot)
...
bind_rows(mc_lai_sla, mc_lai_litter, mc_lai_both) %>% 
  ...
  labs(x = expression(LAI~(m^2~m^-2)),
       y = "Density")
ggsave("figures/fig6-lai-mc.png")
