...
sla_by_species %>% 
  knitr::kable(digits = 1, format = "html", 
               col.names = c("Species", "N", "SLA (cm2/g)", "s.d."), 
...
sla %>% 
  ...
  summarise(n = n(), 
            ...
            sd_SLA = sd(specific_leaf_area)) %>% 
  knitr::kable(digits = 1, format = "html", 
               col.names = c("Species", "Plot", "N", "SLA (cm2/g)", "s.d."), 
...
sla %>% 
  ...
  summarise(n = n(), 
            ...
            sd_SLA = sd(specific_leaf_area)) %>% 
  knitr::kable(digits = 1, format = "html", 
               col.names = c("Elevation", "N", "SLA (cm2/g)", "s.d."),
...
sla %>%
  ...
  summarise(n = n(),
            ...
            sd_SLA = sd(specific_leaf_area)) %>% 
  knitr::kable(digits = 1, format = "html", 
               col.names = c("Species", "Canopy position", "N", "SLA (cm2/g)", "s.d."), 
...
sla %>%
  ...
  summarise(n = n(), 
            ...
            sd_SLA = sd(specific_leaf_area)) %>% 
  knitr::kable(digits = 1, format = "html", 
               col.names = c("Species", "Salinity exposure", "N", "SLA (cm2/g)", "s.d."),
...
sla %>%
  ...
  knitr::kable(digits = 1, format = "html",
               caption = "Table 6: Specific leaf area along salinity gradient by species") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive", full_width = FALSE))

# Table 7: SLA along salinity gradient
sla %>%
  filter(!is.na(Salinity)) %>% 
  group_by(Species, Salinity) %>% 
  ...
  spread(Salinity, mean_SLA) %>% 
  knitr::kable(digits = 1, format = "html",
               caption = "Table 7: Specific leaf area (cm2/g) along salinity gradient") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive", full_width = FALSE))
```
...
# Figure 1
fig1 <- sla_poster %>% 
  left_join(sla_by_species, by = "Species_common") %>% 
