...
``` {r SERC map}
sites <- read.csv("Design/sites.csv")
...
ggmap(sites_map) +
  ...
  geom_text(data = sites, aes(x = Longitude, y = Latitude, label = Plot)) +
  labs(title = "SLA Sampling Plots", x = "Longitude", y = "Latitude", size = 1)
