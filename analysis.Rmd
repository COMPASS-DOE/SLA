...
pacman::p_load(dplyr, tidyr, readr, knitr, kableExtra, lme4,
...
sla %>%
  ...
  summarise(
    mean_SLA = paste(round(mean(SLA), digits = 1), "±", round(sd(SLA), digits = 1),
...
lmer(SLA ~ Species * DBH + Position + (1 | Plot:Species),
